...
namespace NLayerApp.WEB.Controllers
{
    public class CompanyController : Controller
    {
        ...
        public CompanyController(ICategoryDTOService serviceCategory,ICompanyOfferDTOService serviceCompanyOffer, ICompanyDTOService serviceCompany, IOfferDTOService serviceOffer)
        {
